...
def JoinCUG(cug_id, msisdn, user_pwd='00000000'):
					   ...
					   <header>
					    ...
					    <body>
						 <CUGID>cug_id</CUGID>
					         ...
					         <isAllowOutgoingCall>Y</isAllowOutgoingCall>
    ...
    if return_msg == 'Successful':
        print('JoinCUG request has been executed successfully !')
    else:
        raise Exception('JoinCUG: ' + return_msg)
