...
def QueryProfileAndBal(phone_number):
   ...
   <soapenv:Body>
						...
						<zsmart>
							<Data>
								<header>
									...
									<REQUEST_ID>0121810220444048103</REQUEST_ID>
								</header>
								<body>
									<MSISDN>phone_number</MSISDN>
									<TransactionSN>201809220444041.S</TransactionSN>
									<UserPwd></UserPwd>
								</body>
							</Data>
						</zsmart>
    ...
    if return_msg == 'Successful':
        print('QueryProfileAndBal request has been executed successfully !')
    else:
        raise Exception('QueryProfileAndBal: ' + return_msg)
